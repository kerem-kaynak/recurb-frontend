    ...
    <GradientBorderCard>
        ...
        <form className="flex flex-col py-8" onSubmit={handleSubmit}>
          ...
          <label className="flex flex-col gap-2 font-bold text-2xl w-1/2">
            ...
            <label className="flex flex-col gap-2 font-bold text-2xl w-1/2">
              Subscription:
              <select value={defaultId ? parseInt(defaultId) : chosenSubscription} onChange={(e) => setChosenSubscription(e.target.value)} className="px-2 h-9 bg-neutral-700 rounded-md text-lg font-medium focus:outline-none">
...
export default CreateReminderWithId